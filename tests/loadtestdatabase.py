...
## Add groceries
grocery1 = grocery.Grocery(1, 1, 1, 2.99, 1, datetime.datetime.isoformat(2021, 4, 12), 1)
grocery2 = grocery.Grocery(2, 1, 1, 3.99, 1, datetime.datetime.isoformat(2021, 1, 6), 1)
grocery3 = grocery.Grocery(1, 4, 2, 4.99, 2, datetime.datetime.isoformat(2021, 1, 6), 1)
grocery4 = grocery.Grocery(2, 3, 1, 2.99, 2, datetime.datetime.isoformat(2020, 12, 9), 1)
grocery5 = grocery.Grocery(2, 2, 1, 1.99, 3, datetime.datetime.isoformat(2020, 12, 9), 2)
grocery6 = grocery.Grocery(1, 2, 1, 5.99, 2, datetime.datetime.isoformat(2020, 10, 1), 1)
db.add(grocery1)
db.add(grocery2)
db.add(grocery3)
db.add(grocery4)
